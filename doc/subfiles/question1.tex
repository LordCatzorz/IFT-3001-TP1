...
La complexité de la fonction \lstinline{std::vector::assign} est linéaire sur la valeur du premier paramètre.
...
Le bloc C est composé uniquement du deuxième bloc du if, soit:
\begin{lstlisting}
    B.assign(VECTOR_SIZE, 0);
...
une complexité linéaire sur la valeur du premier paramètre, alors que la fonction \lstinline{std::vector::at}
est constante. Donc
