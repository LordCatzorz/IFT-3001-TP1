...
\begin{deriv}
    ...
    2 \cdot \crochs{2 \cdot C\pars{3^{k-2}}+3^k} +3^k
    \<=
    \commentaire{Simplification}
    2^2 \cdot C\pars{3^{k-2}}+ 2 \cdot 3^k
    \<=
    \commentaire{$3^e$ induction}
    2^2 \cdot \crochs{2 \cdot C\pars{3^{k-3}}+3^k}+ 2 \cdot 3^k
    \<=
    \commentaire{Simplification}
    2^3 \cdot C\pars{3^{k-3}}+ 3 \cdot 3^k
    \<=
    \commentaire{Suite}
    ...
    \<=
    \commentaire{$i^e$ induction}
    2^i \cdot C\pars{3^{k-i}}+ i \cdot 3^k
    \<=
    \commentaire{Suite}
    ...
    \<=
    \commentaire{$k^e$ induction}
    2^k \cdot C\pars{3^{k-k}}+ k \cdot 3^k
    \<=
    \commentaire{Simplification}
    2^k \cdot C\pars{3^{0}}+ k \cdot 3^k
    \<=
    \commentaire{Valeur de base}
    2^k \cdot 0+ k \cdot 3^k
    \<=
    \commentaire{Simplification}
    k \cdot 3^k
\end{deriv}
